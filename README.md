...
| PUT | `/api/ai/analyses/:id/steps/:index` | Set an action-plan step's status (pending/applied/verified/dismissed) |
...
| PUT | `/api/ai/analyses/:id/steps/:index` | Fija el estado de un paso del plan (pending/applied/verified/dismissed) |
